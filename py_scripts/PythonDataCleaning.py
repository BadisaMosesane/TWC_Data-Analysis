...
# set value of specified options, max_rows & max_cols
...
# # Cleansed water levels DF

# In[40]:


# save water levs as csv
...
# merge the two Ramotswa DFs, use an outer join
